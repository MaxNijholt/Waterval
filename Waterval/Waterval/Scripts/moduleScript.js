...
$('input[name="addGradeType"] ').click(function () {
    var fieldvalue = $('[name=TempValue]').val();
    if (fieldvalue) {
        var inputfield = '<tr><td><input type="text" class="form-control" id="field_descriptionGradeType" value="' + fieldvalue + '"/></td>';
        var buttonDelete = '<td><input type="button" value="-" id="btn_deleteGradeType" class="btn btn-danger"/></td></tr>';
...
//We will Fill the definition after that.
$('input[name="addGradeTypebetween"] ').click(function () {
    var fieldvalue = $('[name=TempValue]').val();
...
$(document).on('click', '#btn_deleteGradeType', function () {
...
$(document).on('change', '#field_descriptionGradeType', function () {
    fillDefinition();
});
...
function fillDefinition() {
    ...
    $('input[id=field_descriptionGradeType]').each(function () {
...
$('input[name="btn_collapseGradeType"] ').click(function () {
    $('[name=TempValue]').val(null);
}
);
...
$(document).on('click', '#btn_addLearnLine', function () {
    ...
    var LearnLineTitle = '<tr id="' + id + '"><td>' + tablevalue[0] + '</td>';
    ...
    $('#LearnLineTable').append(LearnLineTitle + buttonDelete);
...
$(document).on('click', '#btn_deleteLearnLine', function () {
    ...
    if (confirm('Deze gegevens verwijderen?')) {
        ...
        //Add row to table
        $('#TableLearnLine').append(LearnLineTitle + buttonAdd);
            ...
            if ($(this).attr('id') != null) {
                //$(this).find("input[type=number]").each(function () {
                    if ($(this).attr('name').match("ID$")) {
                        $(this).attr('name', 'Module_ID')
                        $(this).attr('id', 'Module_ID')
                    }
                    else {
                        $(this).attr('name', 'LearnLine_ID')
                        $(this).attr('id', 'LearnLine_ID')
                    }
                //});
                index += 1;
            }
...
////Then we will add the data to the table after that we clear the inputfield
////We will Fill the definition after that.
//$('input[name="addWorkform"] ').click(function () {
//    var fieldvalue = $('[name=TempValue]').val();
//    var fieldvalue2 = $('[name=TempValue2]').val();
//    var fieldvalue3 = $('[name=TempValue3]').val();
//    var fieldvalue4 = $('[name=TempValue4]').val();

//    if (fieldvalue && fieldvalue2 && fieldvalue3 && fieldvalue4) {
//        var inputfield = '<tr><td><input type="text" class="form-control" id="Workform" value="' + fieldvalue + '"/></td>';
//        var inputfield2 = '<tr><td><input type="text" class="form-control" id="Duration" value="' + fieldvalue2 + '"/></td>';
//        var inputfield3 = '<tr><td><input type="text" class="form-control" id="Frequency" value="' + fieldvalue3 + '"/></td>';
//        var inputfield4 = '<tr><td><input type="text" class="form-control" id="Workload" value="' + fieldvalue4 + '"/></td>';
//        var buttonDelete = '<td><input type="button" value="-" id="btn_delete" class="btn btn-danger"/></td></tr>';
//        $('#LongTable').append(inputfield + inputfield2 + inputfield3 + inputfield4 + buttonDelete);
//        $('[name=TempValue]').val(null);
//        $('[name=TempValue2]').val(null);
//        $('[name=TempValue3]').val(null);
//        $('[name=TempValue4]').val(null);
//        fillDefinition();
//    }
//});
...
////after that we clear the inputfield
////We will Fill the definition after that.
//$('input[name="addWorkformbetween"] ').click(function () {
//    var fieldvalue = $('[name=TempValue]').val();
//    var fieldvalue2 = $('[name=TempValue2]').val();
//    var fieldvalue3 = $('[name=TempValue3]').val();
//    var fieldvalue4 = $('[name=TempValue4]').val();
//    var index = $("#selecteer").val();
//    if (fieldvalue && fieldvalue2 && fieldvalue3  && fieldvalue4 && index > 0) {
//        var inputfield = '<tr><td><input type="text" class="form-control" id="Workform" value="' + fieldvalue + '"/></td>';
//        var inputfield2 = '<tr><td><input type="text" class="form-control" id="Duration" value="' + fieldvalue2 + '"/></td>';
//        var inputfield3 = '<tr><td><input type="text" class="form-control" id="Frequency" value="' + fieldvalue3 + '"/></td>';
//        var inputfield4 = '<tr><td><input type="text" class="form-control" id="Workload" value="' + fieldvalue4 + '"/></td>';
//        var buttonDelete = '<td><input type="button" value="-" id="btn_delete" class="btn btn-danger"/></td></tr>';
//        $('#Workform > tbody > tr').eq(index - 1).after(inputfield + inputfield2 + inputfield3 + inputfield4 + buttonDelete);
//        $('[name=TempValue]').val(null);
//        $('[name=TempValue2]').val(null);
//        $('[name=TempValue3]').val(null);
//        $('[name=TempValue4]').val(null);
...
////Whenever text get changed and the textbox gets leaved this function will be called
////fillDefinition will get called
//$(document).on('change', '#Workform', function () {
//    fillDefinition();
//});
...
//    var arrText = new Array();
//    $('input[id=Workform]').each(function () {
//        arrText.push($(this).val());
//        options.append($("<option />").val(index).text($(this).val()));
//        index++;
//    })
...
//        index++;
//    })
//    $('input[id=Frequency]').each(function () {
//        arrText.push($(this).val());
//        options.append($("<option />").val(index).text($(this).val()));
//        index++;
//    })
//    $('input[id=Workload]').each(function () {
//        arrText.push($(this).val());
//        options.append($("<option />").val(index).text($(this).val()));
//        index++;
//    })
...
////Everytime the accordion gets opened or closed the inputfield gets cleared.
//$('input[name="btn_collapseWorkform"] ').click(function () {
//    $('[name=TempValue]').val(null);
//    $('[name=TempValue2]').val(null);
//    $('[name=TempValue3]').val(null);
//    $('[name=TempValue4]').val(null);
